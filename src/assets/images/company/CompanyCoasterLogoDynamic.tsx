...
import { Ellipse, Path, Rect, Svg, Defs, G, Mask, Stop, Circle, LinearGradient, EMaskUnits } from 'react-native-svg'
...
const CompanyCoasterLogoDynamic: React.FC<Props> = ({ width, height, backgroundColor, iconColor }: Props) => {
